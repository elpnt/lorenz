...
//   return (
//     <ReactAria.Dialog open={open} onClose={close} className="lg:hidden">
//       <ReactAria.DialogBackdrop
//         transition
//         className="fixed inset-0 bg-black/30 transition data-closed:opacity-0 data-enter:duration-300 data-enter:ease-out data-leave:duration-200 data-leave:ease-in"
//       />
//       <ReactAria.DialogPanel
//         transition
...
//             {/* <ReactAria.CloseButton as={NavbarItem} aria-label="Close navigation"> */}
//             <CloseMenuIcon />
//             {/* </ReactAria.CloseButton> */}
//           </div>
//           {children}
//         </div>
//       </ReactAria.DialogPanel>
